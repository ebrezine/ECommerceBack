...
public class productController_test {
    ...
    void shouldCreateProduct() throws Exception{
        Product product = new Product(1, 2, 2.50, "description", "image.png", "name");
    ...
    void shouldReturnListOfProducts() throws Exception{
        List<Product> products = new ArrayList<>(
            Arrays.asList(new Product(1, 2, 2.50, "description1", "image1.png", "name1"),
            new Product(2, 2, 3.50, "description2", "image2.png", "name2"),
            new Product(3, 5, 4.50, "description3", "image3.png", "name3"))
        );
